---
id: password-hashing-advisor
name: Password Hashing Advisor
...
tags:
  ...
  - secure-coding
summary: |
  This Codex skill reviews password storage to ensure hashing uses Argon2id (preferred), bcrypt with cost >= 12, or scrypt with approved parameters, and that salts are unique per-user and stored alongside the hash.
