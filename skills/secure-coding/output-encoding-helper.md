---
id: output-encoding-helper
name: Output Encoding Helper
...
tags:
  ...
  - secure-coding
summary: |
  This Codex skill ensures that every value rendered into HTML, JavaScript, CSS, URL, or attribute context is encoded with the correct context-specific encoder, eliminating reflected and stored XSS.
