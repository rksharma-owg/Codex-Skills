...
tags:
  ...
  - secure-coding
summary: |
  This Codex skill reviews C, C++, Rust (unsafe), and Zig code for memory safety defects: buffer overflows, use-after-free, double-free, out-of-bounds reads/writes, format string bugs, and integer overflows that lead to memory corruption.
