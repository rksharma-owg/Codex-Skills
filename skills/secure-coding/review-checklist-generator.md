...
tags:
  ...
  - secure-coding
summary: |
  This Codex skill generates a per-PR review checklist tailored to the change type, language, framework, and affected areas (auth, payments, infra, UI).
