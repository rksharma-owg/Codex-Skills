...
tags:
  ...
  - soc-2
summary: |
  This Codex skill designs an audit logging system that meets compliance requirements (SOC 2, HIPAA, PCI): what to log, the log format, tamper-evidence, retention, and access control.
