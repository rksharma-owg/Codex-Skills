...
tags:
  ...
  - iam
summary: |
  This Codex skill uses GCP's IAM Recommender and additional analysis to identify over-permissive IAM bindings, service accounts with unused keys, and workloads running with default service accounts.
