---
id: cloudtrail-forensics-helper
name: CloudTrail Forensics Helper
...
tags:
  ...
  - s3
summary: |
  This Codex skill queries AWS CloudTrail logs to investigate a security incident: identifies the source IP, user agent, API calls, and resources affected by a suspicious activity.
