---
id: kubernetes-network-policy-generator
name: Kubernetes NetworkPolicy Generator
...
tags:
  ...
  - s3
summary: |
  This Codex skill generates NetworkPolicy YAML for a Kubernetes namespace based on the actual observed traffic between pods.
