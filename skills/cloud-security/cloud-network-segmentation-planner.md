---
id: cloud-network-segmentation-planner
name: Cloud Network Segmentation Planner
...
tags:
  ...
  - terraform
summary: |
  This Codex skill designs a network segmentation strategy for a cloud workload: VPC design, subnet tiers (public, private, data), security group rules, NetworkPolicy for Kubernetes, and firewall rules for east-west traffic.
