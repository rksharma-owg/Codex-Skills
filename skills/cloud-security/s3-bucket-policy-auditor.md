---
id: s3-bucket-policy-auditor
name: S3 Bucket Policy Auditor
...
tags:
  ...
  - s3
summary: |
  This Codex skill audits S3 buckets for public exposure, missing encryption, missing versioning, missing access logs, and permissive bucket policies.
