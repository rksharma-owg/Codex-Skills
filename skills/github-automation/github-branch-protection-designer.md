---
id: github-branch-protection-designer
name: GitHub Branch Protection Designer
...
tags:
  ...
  - terraform
summary: |
  This Codex skill designs branch protection rules for a repository: required reviews, required status checks, required linear history, force-push protection, deletion protection, and signed commits.
