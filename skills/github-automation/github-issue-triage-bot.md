...
tags:
  ...
  - rds
summary: |
  This Codex skill designs a GitHub Actions bot that triages new issues: applies labels based on content, requests more info from the reporter, marks stale issues, and closes duplicates.
