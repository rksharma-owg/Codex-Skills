---
id: github-oidc-cloud-federation-setup
name: GitHub OIDC Cloud Federation Setup
...
tags:
  ...
  - terraform
summary: |
  This Codex skill sets up OIDC federation between GitHub Actions and a cloud provider (AWS, GCP, Azure) so workflows can authenticate without long-lived secrets.
