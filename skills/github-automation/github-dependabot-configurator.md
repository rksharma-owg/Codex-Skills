---
id: github-dependabot-configurator
name: GitHub Dependabot Configurator
...
tags:
  ...
  - terraform
summary: |
  This Codex skill configures Dependabot for a repository: dependency ecosystems, update schedule, grouping, reviewers, assignees, and commit message conventions.
