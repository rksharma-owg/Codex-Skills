---
id: llm-output-filter-designer
name: LLM Output Filter Designer
...
tags:
  ...
  - rds
summary: |
  This Codex skill designs output filters for an LLM application: content moderation (toxicity, PII, regulated content), format validation (JSON schema, regex), and safety guards (no tool invocation without approval).
