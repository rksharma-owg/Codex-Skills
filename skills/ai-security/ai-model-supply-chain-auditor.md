---
id: ai-model-supply-chain-auditor
name: AI Model Supply Chain Auditor
...
tags:
  ...
  - pytorch
summary: |
  This Codex skill audits the supply chain of AI models used by an application: model provenance (Hugging Face, OpenAI, internal), license compatibility, training data disclosure, known vulnerabilities in model files (pickle deserialization, malicious weights), and version pinning.
