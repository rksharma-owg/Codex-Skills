...
tags:
  ...
  - prometheus
summary: |
  This Codex skill designs a monitoring system for ML model drift: input drift (feature distribution shift), output drift (prediction distribution shift), and concept drift (the relationship between input and output changes).
