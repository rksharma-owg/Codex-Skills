---
id: vector-db-security-auditor
name: Vector DB Security Auditor
...
tags:
  ...
  - tls
summary: |
  This Codex skill audits a vector database (Pinecone, Weaviate, Milvus, pgvector) for security: authentication, authorization (per-namespace ACLs), encryption (at rest, in transit), data isolation (multi-tenant), and access logging.
