---
id: argo-workflow-generator
name: Argo Workflow Generator
category: devops
...
tags:
  ...
  - s3
summary: |
  This Codex skill generates Argo Workflow YAML for batch, ETL, and ML pipelines with retry strategies, artifact passing, parameter propagation, exit handlers for cleanup, and conditional steps.
