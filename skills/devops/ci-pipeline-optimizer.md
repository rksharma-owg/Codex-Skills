...
tags:
  ...
  - github-actions
summary: |
  This Codex skill analyzes a CI pipeline (GitHub Actions, GitLab CI, CircleCI) and produces an optimization plan: caching strategy, parallelization, matrix pruning, conditional jobs, and step merging.
