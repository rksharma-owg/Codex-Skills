...
tags:
  ...
  - incident-response
summary: |
  This Codex skill reconstructs an incident timeline from logs, alerts, chat messages, and commit history: detection time, page time, ack time, mitigation start, mitigation complete, resolution.
