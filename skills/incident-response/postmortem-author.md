...
tags:
  - incident-response
summary: |
  This Codex skill authors a blameless postmortem document for a resolved incident: summary, timeline, impact, root cause, contributing factors, what went well, what went poorly, action items.
