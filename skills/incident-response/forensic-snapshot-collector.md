---
id: forensic-snapshot-collector
...
tags:
  ...
  - s3
summary: |
  This Codex skill orchestrates the collection of forensic snapshots during a security incident: disk images, memory dumps, network captures, log bundles, and database snapshots.
