...
tags:
  ...
  - incident-response
summary: |
  This Codex skill classifies a reported incident by severity (SEV1 through SEV4) based on impact (users affected, revenue loss, data exposure) and urgency (is it getting worse, is there a workaround).
