...
tags:
  ...
  - sonarqube
summary: |
  This Codex skill triages raw Static Application Security Testing (SAST) output from tools like Semgrep, CodeQL, Snyk Code, SonarQube, and Fortify into a de-duplicated, prioritized, false-positive-aware queue that developers can actually act on.
