...
tags:
  ...
  - semgrep
summary: |
  This Codex skill detects SQL Injection (SQLi) vulnerabilities — classic, blind, second-order, and stored-procedure-based — across codebases in any language.
