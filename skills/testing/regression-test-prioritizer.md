...
name: Regression Test Prioritizer
category: testing
...
tags:
  ...
  - testing
summary: |
  This Codex skill analyzes a PR diff and selects the subset of existing tests most likely to catch regressions caused by this change.
