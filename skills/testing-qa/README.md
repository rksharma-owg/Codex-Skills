...
Coverage for automated testing, browser workflows, end-to-end quality, and test architecture decisions.

## Overview

- Total curated skills: 8
- Highest-ranked entry: `anthropics/skills@webapp-testing`
- Coverage: ranks 21 through 28
