...
- A dedicated application security skill package with installation guidance and supporting files.
...
| `skills/application-security/` | Application security skill package with install guidance and reference files. |
